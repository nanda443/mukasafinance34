{{-- resources/views/admin/show-jenis-pembayaran.blade.php --}}
@extends('layouts.app')
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ Auth::user()->role == 'admin' ? route('admin.dashboard') : route('bendahara.dashboard') }}">
                            Dashboard
                        </a>
                    </li>
                    <li class="breadcrumb-item">
                        <a href="{{ Auth::user()->role == 'admin' ? route('admin.jenis-pembayaran.index') : route('bendahara.jenis-pembayaran.index') }}">
                            Jenis Pembayaran
                        </a>
                    </li>
...
<section class="content">
    <div class="container-fluid">
                                ...
                                <table class="table table-bordered table-striped table-hover" id="table-pembayaran">
                                    ...
                                    <tbody>
                                        @foreach($jenisPembayaran->pembayarans as $index => $pembayaran)
                                            {{-- PERBAIKAN: Cek data sebelum mengakses properti --}}
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ Auth::user()->role == 'admin' ? route('admin.jenis-pembayaran.index') : route('bendahara.jenis-pembayaran.index') }}" class="btn btn-secondary">
